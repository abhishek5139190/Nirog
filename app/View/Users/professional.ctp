                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-xs-12 form-group">
                        ...
                        <div class="pre-result DocTime" data-bind="foreach: DocTimeList" >
                            <div class="col-md-4 box" style="padding:2px 2px 2px 6px; border-radius:4px; margin-top:2px">
                                <ul class="result-doc" >
                    ...
                    <div class="boxs">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-6 form-group">
                                ...
                                <input type="text" id="otherCity" class="form-control" placeholder="Other Degree" style="display:none"></input>
                            </div>
    ...
    var DocTimeVm = function () {
        ...
        $('.coadd').on("click", function () {
            ...
            $.post("" + ur + "Courses/add", {
                ...
                if (d.r == 1) {
                    $("#course").html("<added successfully!</b>");
