<div class="left-sidebar col-md-3 col-sm-4 col-xs-12">
    ...
    <ul>
        <li><a href="<?php echo $this->Html->url('/', true) ?>users/personal" class="active"><i class="fa fa-user"></i> Personal Information</a></li>
        <li><a href="<?php echo $this->Html->url('/', true) ?>users/professional"><i class="fa fa-user"></i> Porfessional Information</a></li>
        
        <li><a href="<?php echo $this->Html->url('/', true) ?>users/document"><i class="fa fa-edit"></i> Documents</a></li>
    </ul>
</div>
<style>
    #upload_link{
